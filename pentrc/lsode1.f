...
C-----------------------------------------------------------------------
 ...
 626  MSG = 'LSODE-  At start of problem, too much accuracy   '
      ...
      RWORK(14) = TOLSF
      GO TO 700
 627  MSG = 'LSODE-  Trouble in DINTDY1.  ITASK = I1, TOUT = R1'
...
C***LIBRARY   MATHLIB (ODEPACK)
C***TYPE      REAL*8 (SSRCOM-S, DSRCOM1-D)
C***AUTHOR  Hindmarsh, Alan C., (LLNL)
C***DESCRIPTION
C
...
C***LIBRARY   MATHLIB (ODEPACK)
C***TYPE      REAL*8 (SINTDY-S, DINTDY1-D)
C***AUTHOR  Hindmarsh, Alan C., (LLNL)
C***DESCRIPTION
C
...
C***LIBRARY   MATHLIB (ODEPACK)
C***TYPE      REAL*8 (SPREPJ-S, DPREPJ1-D)
C***AUTHOR  Hindmarsh, Alan C., (LLNL)
C***DESCRIPTION
C
...
C***LIBRARY   MATHLIB (ODEPACK)
C***TYPE      REAL*8 (SSOLSY-S, DSOLSY1-D)
C***AUTHOR  Hindmarsh, Alan C., (LLNL)
C***DESCRIPTION
C
...
C***LIBRARY   MATHLIB (ODEPACK)
C***TYPE      REAL*8 (SSTODE-S, DSTODE1-D)
C***AUTHOR  Hindmarsh, Alan C., (LLNL)
C***DESCRIPTION
C
