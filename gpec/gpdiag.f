...
! c     MCP: Is there a reason this subroutine exists still?
! c          It isn't called anywhere, and there seems to be a duplicate
! c          in gpout_dw_matrix. Commenting out for now.
! c-----------------------------------------------------------------------
...
!       REAL(r8) :: jarea,ileft
!       COMPLEX(r8) :: t1,t2
!       LOGICAL :: diagnose1=.TRUE.,diagnose2=.TRUE.
