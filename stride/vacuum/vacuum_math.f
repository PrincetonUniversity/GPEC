...
c$$$c-----------------------------------------------------------------------
c$$$c     subprogram 7. aleg.
c$$$c     computes Legendre functions.
c$$$c-----------------------------------------------------------------------
c$$$c-----------------------------------------------------------------------
c$$$c     declarations.
c$$$c-----------------------------------------------------------------------
c$$$      SUBROUTINE aleg(x,nloc,pm,pn,pp, aleg0,aleg1)
c$$$      IMPLICIT NONE
c$$$
c$$$      REAL(8), INTENT(IN) :: x
c$$$      INTEGER, INTENT(IN) :: nloc
c$$$      REAL(8), INTENT(OUT) :: pm,pn,pp,aleg0,aleg1
c$$$
c$$$      INTEGER :: kloc
c$$$      REAL(8) :: ak02,elipe,elipk,gam,s,v,w,x1,x2,x3,x4,xxq,y,ysq
c$$$
c$$$      REAL(8), PARAMETER :: pi=3.1415926535897931_8,pii=2/pi,
c$$$     $     sqpi=1.7724538509055159_8
c$$$      REAL(8), PARAMETER :: 
c$$$     $     ak0=1.38629436112_8,
c$$$     $     ak1=0.09666344259_8,
c$$$     $     ak2=0.03590092383_8,
c$$$     $     ak3=0.03742563713_8,
c$$$     $     ak4=0.01451196212_8,
c$$$     $     bk0=0.5_8,
c$$$     $     bk1=0.12498593597_8,
c$$$     $     bk2=0.06880248576_8,
c$$$     $     bk3=0.03328355346_8,
c$$$     $     bk4=0.00441787012_8,
c$$$     $     ae1=0.44325141463_8,
c$$$     $     ae2=0.0626060122_8,
c$$$     $     ae3=0.04757383546_8,
c$$$     $     ae4=0.01736506451_8,
c$$$     $     be1=0.2499836831_8,
c$$$     $     be2=0.09200180037_8,
c$$$     $     be3=0.04069697526_8,
c$$$     $     be4=0.00526449639_8
c$$$c-----------------------------------------------------------------------
c$$$c     preliminary computations.
c$$$c-----------------------------------------------------------------------
c$$$      gam=sqpi
c$$$      xxq=x*x
c$$$      s=(x-1)/(x+1)
...
c$$$      x3=x2*x1
c$$$      x4=x3*x1
c$$$      elipk=ak0+ak1*x1+ak2*x2+ak3*x3+ak4*x4
c$$$     $     -(bk0+bk1*x1+bk2*x2+bk3*x3+bk4*x4)*dlog(x1)
c$$$      pn=pii*SQRT(2/(x+1))*elipk
c$$$      aleg0=pn
c$$$      x1=1/w**2
c$$$      x2=x1*x1
c$$$      x3=x2*x1
...
c$$$      elipe=1
c$$$      IF(ABS(x1)  >  1e-6)
c$$$     $     elipe=1+ae1*x1+ae2*x2+ae3*x3+ae4*x4
c$$$     $     -(be1*x1+be2*x2+be3*x3+be4*x4)*dlog(x1)
c$$$      pp=(pii*SQRT(w)*elipe-x*pn)/(2*y)
c$$$      aleg1=pp
c$$$c-----------------------------------------------------------------------
c$$$c     iterate.
c$$$c-----------------------------------------------------------------------
...
c$$$         pm=pn
c$$$         pn=pp
c$$$         pp=-2*kloc*x*pn/y-ak02*ak02*pm
c$$$         gam=gam/ak02
c$$$      ENDDO
c$$$c-----------------------------------------------------------------------
c$$$c     termination.
